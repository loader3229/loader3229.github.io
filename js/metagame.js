...
setInterval(function () {
    try {
        ...
        if (document.location.href.indexOf("/incrementalgames") != -1) {
            if (player.stat >= 1) $("#metagamelink").html((localStorage.lang == 1 ? "元-游戏 -- 分数倍率：" : "Metagame -- Point Multiplier: ") + player.metapoints.add(1).log10().div(1000).add(1).min(1.58).mul(100).toNumber().toFixed(2) + "%");
